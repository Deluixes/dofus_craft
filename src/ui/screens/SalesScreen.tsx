...
import { committedKamas, hoursUntilExpiry, realizedProfit, type Sale } from '../../domain/sale'
  ...
  return (
    <li className="sale-card" data-urgent={urgent}>
      ...
      <div className="sale-card__details">
        <span className="sale-card__qty">×{sale.quantity}</span>
